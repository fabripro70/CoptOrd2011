...
#Region "Public Subs and Functions"
    ...
    Public Sub DownloadFile(ByVal sFileName As String)
        DownloadFile(sFileName, "", False, Nothing)
    End Sub
    ...
    Public Sub DownloadFile(ByVal sFileName As String, _
        ...
        DownloadFile(sFileName, "", bResume, Nothing)
    End Sub
    ...
    Public Sub DownloadFile(ByVal sFileName As String, _
                            ByVal sLocalFileName As String, ByVal Progress As Control)
        DownloadFile(sFileName, sLocalFileName, False, Progress)
    End Sub
    ...
    Public Sub DownloadFile(ByVal sFileName As String, _
                            ...
                            ByVal bResume As Boolean, ByVal Progress As Control)
        Dim st As Stream
        Dim output As FileStream
        Dim cSocket As Socket
        Dim offset, npos, totByte As Long
        ...
        Do While (True)
            ...
            totByte = totByte + m_iBytes
            Progress.Text = totByte
            Progress.Refresh()
    ...
    Public Function UploadFile(ByVal sFileName As String, ByVal progress As Control) As Boolean
        UploadFile = UploadFile(sFileName, False, progress)
    End Function
    ' This is a function that is used to upload a file from your local hard disk to your FTP site
    ' and then set the resume flag.
    Public Function UploadFile(ByVal sFileName As String, _
                          ByVal bResume As Boolean, ByVal progress As Control) As Boolean
        Dim cSocket As Socket
        Dim offset As Long
...
#Region "Private Subs and Functions"
    ...
    Private Function ReadLine(Optional ByVal bClearMes As Boolean = False) As String
        ...
        Catch ex As System.Net.Sockets.SocketException
            MsgBox(ex.Message, MsgBoxStyle.Exclamation, "ftpReadLine")
        End Try
